...
import com.charleex.autoytvid.yt.model.toUploadListItem
import com.charleex.autoytvid.yt.util.toInstant
...
internal class ChannelUploadsServiceImpl(
    ...
    override suspend fun getUploadList(): List<ChannelUploadsItem> {
        ...
        val playlistItemRequest: YouTube.PlaylistItems.List = getPlaylistItemRequest(uploadPlaylistId)
    ...
    override suspend fun getVideoDetail(videoId: String): ChannelUploadsItem {
        ...
        videoList.fields = "items(id,snippet/title,snippet/description,snippet/publishedAt,contentDetails/duration)"
        ...
        return ChannelUploadsItem(videoId, title, description, publishedAt.toInstant())
    }
